...
namespace Wtdl.Repository.Migrations
{
    ...
    [Migration("20230307080024_add-memoery-index")]
    partial class addmemoeryindex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Weitedianlan.Model.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 7, 16, 0, 24, 549, DateTimeKind.Local).AddTicks(2434));
            ...
            modelBuilder.Entity("Weitedianlan.Model.Entity.W_LabelStorage", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 7, 16, 0, 24, 548, DateTimeKind.Local).AddTicks(9274));
