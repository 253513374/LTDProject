<%@ WebHandler Language="C#" Class="Hongbao1" %>

using System;
using System.Web;
using System.Web.SessionState;

public class Hongbao1 : IHttpHandler, IRequiresSessionState
{
       ...
       // context.Response.Write("Hello World");
        if (context.Request["ctype"] != null && context.Request["ctype"].ToString() != "")
        {
            ...
            if (context.Request["ctype"].ToString() == "0")
            {
                ...
                string ReStr = Common.APIService.HttpPost("RedPacket/QRCode?openid=" + context.Session["openid"] + "&qrcode=" + code, "");
